export default function Contact() {
  const SOCIAL_LINKS = [
    {
      href: "https://github.com/nguyenthanhhieu2995",
      icon: (
        <svg
          width="24"
          height="24"
    ...
    {
      href: "https://www.facebook.com/hieu.nguyenthanh.2995",
      icon: (
        <svg
          width="24"
          height="24"
    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="header-line-2 lg:max-w-[12ch]">Contact me for collaboration</h2>
          ...
          <div className="flex items-center gap-2 mt-auto">
            {SOCIAL_LINKS.map(({ href, icon }, key) => (
              <a key={key} href={href} className="size-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80">
                {icon}
              </a>
            ))}
          </div>
        </div>
        <form action="https://getform.io/f/bwngxwqa" method="POST" className="xl:pl-10 2xl:pl-20">
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="nguyenthanhhieu2995@gmail.com"
              />
            </div>
          </div>
